                                        ...
                                        <div class="listings-content">
                                            ...
                                            <div class="property-meta-data d-flex align-items-end">
                                                ...
                                                <div class="bathroom">
                                                    ...
                                                    <span>{{ $house->numberOfBedroom }}</span>
                                                </div>
                                                <div class="garage">
                                                    <img src="img/icons/garage.png" alt="">
                                                    <span>{{ $house->numberOfBathroom }}</span>
                                                </div>
                                                <div class="space">
                                        ...
                                        <div class="rent-house">
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input readonly class="form-control" type="date" name="checkIn"
                                                           value="{{ Session::get('userRent')['checkIn'] }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input readonly class="form-control" type="date" name="checkOut"
                                                           value="{{ Session::get('userRent')['checkOut'] }}">
                                                ...
                                                <div class="form-group">
                                                    <label for=""><b>Tổng số
                                                            tiền: {{ number_format($totalPrice,0,",",".") }} VNĐ
                                                            ({{ $subDay }} ngày)</b></label>
                                                    <input hidden class="totalPrice" type="text" readonly
